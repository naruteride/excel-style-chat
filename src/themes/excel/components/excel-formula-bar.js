...
export default class ExcelFormulaBar extends HTMLElement {
	...
	render() {
		...
		this.innerHTML = `
			...
			<button style="display: flex; justify-content: center; align-items: center; border-radius: 2rem; padding: 0.25rem; background: rgb(240, 244, 249); font-size: 0.813rem; color: rgb(31, 31, 31);">
				<svg xmlns="http://www.w3.org/2000/svg" height="16px" width="16px" viewBox="0 -960 960 960" fill="none"><path d="M480-80q0-83-31.5-156T363-363q-54-54-127-85.5T80-480q83 0 156-31.5T363-597q54-54 85.5-127T480-880q0 83 31.5 156T597-597q54 54 127 85.5T880-480q-83 0-156 31.5T597-363q-54 54-85.5 127T480-80Z" fill="#1F1F1F"></path></svg>
				이 데이터 요약
			</button>
		`;
	}
