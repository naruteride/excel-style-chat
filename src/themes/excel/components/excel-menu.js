	...
	render() {
		...
		this.innerHTML = `
			<div style="display: flex; align-items: center; margin-inline: 0.5rem;">
				<button class="excel-icon-button" image-position-left="-717px" image-position-top="-926px" style="width: 3.25rem; height: 3.25rem; padding: 0.5rem;"></button>
				...
				<div style="display: flex; flex-direction: column;">
					<div style="display: flex; align-items: center; gap: 0.5rem">
						...
						<button class="excel-icon-button" image-position-left="-202px" image-position-top="-2102px" style="width: 1.75rem; height: 1.75rem; padding: 0.25rem;"></button>
						<button class="excel-icon-button" image-position-left="-1434px" image-position-top="-416px" style="width: 1.75rem; height: 1.75rem; padding: 0.25rem;"></button>
						<button class="excel-icon-button" image-position-left="-660px" image-position-top="-1578px" style="width: 1.75rem; height: 1.75rem; padding: 0.25rem;"></button>
					</div>

					<div style="display: flex; align-items: center; gap: 0.5rem; margin-top: -0.25rem;">
						${menuLabels.map(label => `<button type="button" style="background: none; border: none; color: #444746; font-size: 0.875rem; padding: 2px 6px; border-radius: 4px;">${label}</button>`).join("")}
					</div>
				</div>
			</div>

			<div style="display: flex; align-items: center; gap: 1rem; margin-inline: 1rem;">
				<button class="excel-icon-button" image-position-left="-786px" image-position-top="-1482px" style="width: 2rem; height: 2rem; padding: 0.25rem;"></button>
				<button class="excel-icon-button" image-position-left="-90px" image-position-top="-324px" style="width: 2rem; height: 2rem; padding: 0.25rem;"></button>
				<button type="button" style="display: flex; align-items: center; gap: 0.2rem; padding: 0; border: none; background: none;">
...
customElements.define("excel-menu", ExcelMenu);
