...
const renderIcon = (element) => {
	...
	element.style.cssText = `background: content-box url(/src/themes/excel/images/${image}) no-repeat ${left} ${top}; width: 1rem; height: 1rem; padding: 0; border: none; display: inline-block; ${style}`;
};
