...
export default class ExcelChatInput extends HTMLElement {
	...
	render() {
		...
		this.innerHTML = `
			...
			<input type="text" id="msg-input" placeholder="1000" style="field-sizing: content; border-radius: 0.25rem; min-width: 2.5rem; padding: 0.125rem 0.5rem; font-size: 14px; vertical-align: middle; border: 1px solid #d9d9d9; line-height: 25px;" />
