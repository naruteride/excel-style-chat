...
export default class VSCodeLogin extends BaseComponent {
	...
	render() {
        ...
        `; // Hardcoded VSCode style for now, or fetch from theme props if we want to keep props separate

		this.innerHTML = `
			<div style="${style}">
				<h1 style="font-size: 1.2em; font-weight: normal; margin-bottom: 20px; color: #007acc;">VS Code Stealth Chat</h1>
